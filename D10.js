...
const risultato = sum(10, 20);
console.log("risultato", risultato);

// ********************************
// let sum = (val1 + val2)
// risultatoSomma = (sum)
// console.log("Risultato",risultatoSomma);
// ********************************
...
console.log("numero casuale tra 10 e 20", randomNumber);
...
const randomNumberDice = dice();
console.log("numero casuale tra 1 e 6", randomNumberDice);

/* ESERCIZIO 2
  Crea una funzione chiamata "whoIsBigger" che riceve due numeri come parametri e ritorna il maggiore dei due.
*/
const whoIsBigger = (numero_1,numero_2) => {
...
console.log(whoIsBigger(38,55));
console.log(whoIsBigger(22,32));
...
*/
const stringTransformed = ("I love coding")
...
*/
const deleteOne = (stringa, manipulateString) => {
  if (manipulateString) {
...
console.log(whatDayIsIt()); // Output: il nome del giorno corrente
...
// Esempio di utilizzo
const myBirthday = new Date("2023-07-17"); 
...
const updatedPerson = deleteProp(person, "age");
...
console.log("Anno di uscita dei film", movieYears);
...
const onlyInLastMillennium = (movies) => {
  const lastMillenniumMovies = movies.filter((movie) => {
    const movieYear = parseInt(movie.Year);
    return movieYear >= 2000 && movieYear < 2100;
  });
...
console.log("Film prodotto nel millennio scorso",lastMillenniumMovies);
...
const clearMyList = () => {
  ...
  // Rimuovi tutti gli elementi figlio della lista
...
*/
const aggiungiClasseTagTR = () => {
  const righe = document.getElementsByTagName('tr');
  
  Array.from(righe).forEach(riga => {
